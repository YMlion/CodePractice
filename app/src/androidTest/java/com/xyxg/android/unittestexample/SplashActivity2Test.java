...
@LargeTest @RunWith(AndroidJUnit4.class) public class SplashActivity2Test {

    @Rule public ActivityTestRule<SplashActivity> mActivityTestRule =
            new ActivityTestRule<>(SplashActivity.class);

    @Test public void splashActivity2Test() {
        ...
        ViewInteraction appCompatButton = onView(allOf(withId(R.id.button4), withText("Others"),
                childAtPosition(allOf(withId(R.id.activity_main),
