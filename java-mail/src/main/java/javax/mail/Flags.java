...
public class Flags implements Cloneable, Serializable {
     ...
     */
    @SuppressWarnings("unchecked") public Flags(Flags flags) {
    ...
    public void remove(Flags f) {
        ...
        if (f.user_flags != null) {
            ...
            Enumeration<String> e = f.user_flags.keys();
            while (e.hasMoreElements()) user_flags.remove(e.nextElement());
        }
    }
    ...
    @Override public int hashCode() {
        ...
        if (user_flags != null) {
            Enumeration<String> e = user_flags.keys();
            while (e.hasMoreElements()) hash += e.nextElement().hashCode();
        }
        return hash;
    }
    ...
    @SuppressWarnings("unchecked") @Override public Object clone() {
        ...
        if (this.user_flags != null) f.user_flags = (Hashtable) this.user_flags.clone();
        return f;
    }
    ...
    public String toString() {
        ...
        if ((system_flags & ANSWERED_BIT) != 0) sb.append("\\Answered ");
        if ((system_flags & DELETED_BIT) != 0) sb.append("\\Deleted ");
        if ((system_flags & DRAFT_BIT) != 0) sb.append("\\Draft ");
        if ((system_flags & FLAGGED_BIT) != 0) sb.append("\\Flagged ");
        if ((system_flags & RECENT_BIT) != 0) sb.append("\\Recent ");
        if ((system_flags & SEEN_BIT) != 0) sb.append("\\Seen ");
        if ((system_flags & USER_BIT) != 0) sb.append("\\* ");
        ...
        if (first && sb.length() > 0) sb.setLength(sb.length() - 1);    // smash trailing space
