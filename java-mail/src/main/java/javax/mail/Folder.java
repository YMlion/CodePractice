...
public abstract class Folder implements AutoCloseable {
	 ...
	 */
        return new URLName(storeURL.getProtocol(), storeURL.getHost(), storeURL.getPort(),
                encodedName.toString(), storeURL.getUsername(), null /* no password */);
    }
     ...
     * @see javax.mail.event.ConnectionEvent
     */
    @Override public void close() throws MessagingException {
        close(true);
    }
     ...
     */
    @SuppressWarnings("unchecked") private void queueEvent(MailEvent event,
