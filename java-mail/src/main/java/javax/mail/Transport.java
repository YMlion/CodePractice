...
public abstract class Transport extends Service {
     ...
     * @see javax.mail.event.TransportEvent
     */
    public abstract void sendMessage(Message msg, Address[] addresses, SMTPOutputStream.WritingListener writingListener) throws MessagingException;
     ...
     */
    protected void notifyTransportListeners(int type, Address[] validSent, Address[] validUnsent,
