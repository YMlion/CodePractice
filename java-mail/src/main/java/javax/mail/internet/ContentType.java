...
public class ContentType {
    ...
    public ContentType(String s) throws ParseException {
        ...
        if (tk.getType() != HeaderTokenizer.Token.ATOM) {
            throw new ParseException("In Content-Type string <"
                    + s
                    + ">"
        ...
        if ((char) tk.getType() != '/') {
            throw new ParseException(
                    "In Content-Type string <" + s + ">" + ", expected '/', got " + tk.getValue());
        }
    ...
    public String getBaseType() {
        if (primaryType == null || subType == null) return "";
    ...
    public boolean match(ContentType cType) {
        ...
        // Match subType
        return (subType == null && sType == null) || (subType != null && subType.equalsIgnoreCase(
                sType));
    }
