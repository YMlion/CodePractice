...
public class InternetHeaders {
    private static final boolean ignoreWhitespaceLines =
            PropUtil.getBooleanSystemProperty("mail.mime.ignorewhitespacelines", false);
        ...
        try {
            ...
            do {
                ...
                if (line != null && (line.startsWith(" ") || line.startsWith("\t"))) {
                    ...
                    if (first) {
                        String lt = line.trim();
                        if (lt.length() > 0) lineBuffer.append(lt);
                    } else {
    ...
    public void addHeader(String name, String value) {
        ...
        boolean addReverse =
                name.equalsIgnoreCase("Received") || name.equalsIgnoreCase("Return-Path");
        if (addReverse) pos = 0;
        for (int i = headers.size() - 1; i >= 0; i--) {
            ...
            if (!addReverse && h.getName().equals(":")) pos = i;
        }
