...
public class MimeMessage extends Message implements MimePart {
    ...
    @Override public Address[] getReplyTo() throws MessagingException {
        ...
        if (a == null || a.length == 0) a = getFrom();
        return a;
    }
    ...
    public void setSubject(String subject, String charset) throws MessagingException {
        if (subject == null) {
            ...
            try {
                setHeader("Subject",
                        MimeUtility.fold(9, MimeUtility.encodeText(subject, charset, null)));
    ...
    @Override public synchronized DataHandler getDataHandler() throws MessagingException {
        if (dh == null) dh = new MimeBodyPart.MimePartDataHandler(this);
        return dh;
    }
    ...
    @Override public Object getContent() throws IOException, MessagingException {
	     ...
	     */
            if (c instanceof MimeMultipart) ((MimeMultipart) c).parse();
        }
        return c;
    }
     ...
     * @since JavaMail 1.4
     */
    @Override public void setText(String text, String charset, String subtype)
            throws MessagingException {
     ...
     * @exception MessagingException for failures
     */
    @Override public Message reply(boolean replyToAll) throws MessagingException {
    ...
    private Address[] eliminateDuplicates(List<Address> v, Address[] addrs) {
        ...
        for (int i = 0; i < addrs.length; i++) {
            ...
            if (!found) v.add(addrs[i]);    // add new address to list
        }
    ...
    public void writeTo(OutputStream os, String[] ignoreList)
        ...
        while (hdrLines.hasMoreElements()) los.writeln(hdrLines.nextElement());
    ...
    protected synchronized void updateHeaders() throws MessagingException {
        ...
        if (getHeader("Date") == null) setSentDate(new Date());
        updateMessageID();
