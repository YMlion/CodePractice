...
public class MimeBodyPart extends BodyPart implements MimePart {
    ...
    @Override public DataHandler getDataHandler() throws MessagingException {
        if (dh == null) dh = new MimePartDataHandler(this);
        return dh;
    }
    ...
    @Override public Object getContent() throws IOException, MessagingException {
        ...
        if (cacheMultipart && (c instanceof Multipart || c instanceof Message) && (content != null
                || contentStream != null)) {
            cachedContent = c;
        /*
    ...
    static boolean isMimeType(MimePart part, String mimeType) throws MessagingException {
        ...
        try {
            ...
            try {
                int i = type.indexOf(';');
                if (i > 0) return new ContentType(type.substring(0, i)).match(mimeType);
    ...
    static String getEncoding(MimePart part) throws MessagingException {
        ...
        // of tokenizer.
        if (s.equalsIgnoreCase("7bit") || s.equalsIgnoreCase("8bit") || s.equalsIgnoreCase(
                "quoted-printable") || s.equalsIgnoreCase("binary") || s.equalsIgnoreCase(
                "base64")) {
            return s;
        }
    ...
    static String restrictEncoding(MimePart part, String encoding) throws MessagingException {
	     ...
	     */
            ...
            if (cType.match("multipart/*")) return null;
            if (cType.match("message/*") && !PropUtil.getBooleanSystemProperty(
    ...
    static void updateHeaders(MimePart part) throws MessagingException {
	     ...
	     */
            if (dh instanceof MimePartDataHandler) {
                ...
                if (mpart != part) {
                    if (needCTHeader) part.setHeader("Content-Type", mpart.getContentType());
    ...
    static void writeTo(MimePart part, OutputStream os, String[] ignoreList)
	     ...
	     */
            ...
            if (dh instanceof MimePartDataHandler) {
                ...
                if (mpart.getEncoding() != null) is = mpdh.getContentStream();
            }
            if (is != null) {
