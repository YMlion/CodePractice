...
public class MimeMultipart extends Multipart {
    ...
    protected void initializeProperties() {
        ...
        ignoreMissingEndBoundary =
                PropUtil.getBooleanSystemProperty("mail.mime.multipart.ignoremissingendboundary",
                        true);
        // default to true
     ...
     * of existing values
     */
    @Override public synchronized void addBodyPart(BodyPart part, int index)
     ...
     */
    @Override public synchronized void writeTo(OutputStream os)
