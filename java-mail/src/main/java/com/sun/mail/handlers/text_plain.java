...
public class text_plain extends handler_base {
    ...
    @Override public Object getContent(DataSource ds) throws IOException {
        String enc = null;
     ...
     */
    @Override public void writeTo(Object obj, String type, OutputStream os) throws IOException {
        if (!(obj instanceof String)) {
            throw new IOException("\""
                    + getDataFlavors()[0].getMimeType()
