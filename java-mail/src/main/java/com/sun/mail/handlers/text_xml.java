...
public class text_xml extends text_plain {
    ...
    @Override protected ActivationDataFlavor[] getDataFlavors() {
        return flavors;
    }

    @Override protected Object getData(ActivationDataFlavor aFlavor, DataSource ds)
            throws IOException {
    ...
    /**
     */
    @Override public void writeTo(Object obj, String mimeType, OutputStream os) throws IOException {
        ...
        try {
            ...
            if (obj instanceof DataSource) {
                ...
                transformer.transform(new StreamSource(((DataSource) obj).getInputStream()),
                        result);
            } else {
            ...
            IOException ioex = new IOException(
                    "Unable to run the JAXP transformer on a stream " + ex.getMessage());
            ioex.initCause(ex);
            throw ioex;
    ...
    private boolean isXmlType(String type) {
        try {
            ...
            return ct.getSubType().equals("xml") && (ct.getPrimaryType().equals("text")
