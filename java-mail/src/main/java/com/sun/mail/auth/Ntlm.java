...
public class Ntlm {
     ...
     */
    public Ntlm(String ntdomain, String hostname, String username, String password,
            MailLogger logger) {
    ...
    public String generateType1Msg(int flags) {
        ...
        if (logger.isLoggable(Level.FINE)) logger.fine("type 1 message: " + toHex(msg));
    ...
    public String generateType3Msg(String challenge) {
        ...
        /* nonce is located at type2[24] for 8 bytes */
            ...
            if (logger.isLoggable(Level.FINE)) logger.fine("type 3 message: " + toHex(msg));
