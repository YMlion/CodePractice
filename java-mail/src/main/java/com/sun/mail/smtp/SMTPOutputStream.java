...
public class SMTPOutputStream extends CRLFOutputStream {
    ...
    private WritingListener listener;
    ...
    @Override public void write(byte b[], int off, int len) throws IOException {
        ...
        if (listener != null) {
            writtenSize += len;
            listener.onWriting(writtenSize);
        }
    }
     ...
     */
    public void setListener(WritingListener listener) {
    ...
    public interface WritingListener {
         ...
         * 写入时监听方法
         *
         * @param writtenBytes 写入的字节数
         */
        void onWriting(long writtenBytes);
    }
}
