...
final class LogManagerProperties extends Properties {
    ...
    static {
        ...
        try {
            ...
            zdtoi = findClass("java.time.ZonedDateTime").getMethod("ofInstant",
                    findClass("java.time.Instant"), findClass("java.time.ZoneId"));
     ...
     */
    @SuppressWarnings("VolatileArrayField") private static volatile String[] REFLECT_NAMES;
    /**
     ...
     */
    @SuppressWarnings("UseSpecificCatch") static Comparable<?> getZonedDateTime(LogRecord record) {
        if (record == null) {
            throw new NullPointerException();
        }
    ...
    static long parseDurationToMillis(final CharSequence value) throws Exception {
        try {
            ...
            if (!k.isAssignableFrom(parse.getReturnType()) || !Modifier.isStatic(
                    parse.getModifiers())) {
                throw new NoSuchMethodException(parse.toString());
            }

            final Method toMillis = k.getMethod("toMillis");
            if (!Long.TYPE.isAssignableFrom(toMillis.getReturnType()) || Modifier.isStatic(
                    toMillis.getModifiers())) {
     ...
     * @since JavaMail 1.4.5
     */
    @SuppressWarnings("unchecked") static Comparator<? super LogRecord> newComparator(String name)
            throws Exception {
    ...
    static <T> Comparator<T> reverseOrder(final Comparator<T> c) {
        ...
        try {
            ...
            if (!Modifier.isStatic(m.getModifiers()) && Comparator.class.isAssignableFrom(
                    m.getReturnType())) {
                try {
        ...
        try {
            ...
            if (type.isAssignableFrom(clazz)) {
                ...
                throw new ClassCastException(
                        clazz.getName() + " cannot be cast to " + type.getName());
            }
     ...
     */
    @Override @SuppressWarnings("CloneDoesntCallSuperClone") public synchronized Object clone() {
     ...
     * @since JavaMail 1.4.4
     */
    @Override public String getProperty(final String key, final String def) {
     ...
     * @since JavaMail 1.4.5
     */
    @Override public synchronized Object get(final Object key) {
        Object value;
     ...
     * @since JavaMail 1.4.5
     */
    @Override public synchronized Object put(final Object key, final Object value) {
     ...
     * @since JavaMail 1.4.5
     */
    @Override public synchronized boolean containsKey(final Object key) {
     ...
     * @since JavaMail 1.4.5
     */
    @Override public synchronized Object remove(final Object key) {
        final Object def = preWrite(key);
