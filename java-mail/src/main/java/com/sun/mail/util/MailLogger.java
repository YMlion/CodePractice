...
public final class MailLogger {
    ...
    private String packageOf(Class<?> clazz) {
        ...
        if (p != null) return p.getName();        // hopefully the common case
        String cname = clazz.getName();
        int i = cname.lastIndexOf('.');
        if (i > 0) return cname.substring(0, i);
    ...
    private StackTraceElement inferCaller() {
        ...
        return new StackTraceElement(MailLogger.class.getName(), "log", MailLogger.class.getName(),
                -1);
    }
