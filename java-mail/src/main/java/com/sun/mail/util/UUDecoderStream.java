...
public class UUDecoderStream extends FilterInputStream {
    ...
    public UUDecoderStream(InputStream in) {
        ...
        ignoreMissingBeginEnd =
                PropUtil.getBooleanSystemProperty("mail.mime.uudecode.ignoremissingbeginend",
                        false);
    }
    ...
    private void readPrefix() throws IOException {
        ...
        for (; ; ) {
            ...
            if (line == null) {
                if (!ignoreMissingBeginEnd) throw new DecodingException("UUDecoder: Missing begin");
                // at EOF, fake it
                gotPrefix = true;
                gotEnd = true;
                break;
    ...
    private boolean decode() throws IOException {
	     ...
	     */
            ...
            count = line.charAt(0);
            if (count < ' ') {
                if (!ignoreErrors) throw new DecodingException("UUDecoder: Buffer format error");
                continue;
            }
	     ...
	     */
            ...
            if (line.length() < need + 1) {
                if (!ignoreErrors) throw new DecodingException("UUDecoder: Short buffer error");
                continue;
            }
