...
public class MailSSLSocketFactory extends SSLSocketFactory {
     ...
     */
    @Override public synchronized Socket createSocket(Socket socket, String s, int i, boolean flag)
            throws IOException {
     ...
     */
    @Override public synchronized String[] getDefaultCipherSuites() {
     ...
     */
    @Override public synchronized String[] getSupportedCipherSuites() {
     ...
     */
    @Override public synchronized Socket createSocket() throws IOException {
     ...
     */
    @Override public synchronized Socket createSocket(InetAddress inetaddress, int i,
     ...
     *						java.net.InetAddress, int)
     */
    @Override public synchronized Socket createSocket(String s, int i, InetAddress inetaddress,
     ...
     * @see javax.net.SocketFactory#createSocket(java.lang.String, int)
     */
    @Override public synchronized Socket createSocket(String s, int i)
