...
public class CollectorFormatter extends Formatter {
     ...
     * </pre>
     * <li>{@code com.sun.mail.util.logging.CollectorFormatter.format=These {3} messages occurred
     * between\n{7,date,EEE, MMM dd HH:mm:ss:S ZZZ yyyy} and {8,time,EEE, MMM dd HH:mm:ss:S ZZZ
     * yyyy}\n}
     * <p>
     ...
     * </pre>
     * <li>{@code com.sun.mail.util.logging.CollectorFormatter.format=These {3} messages occurred
     * between {9,choice,86400000#{7,date} {7,time} and {8,time}|86400000<{7,date} and {8,date}}\n}
     * <p>
     ...
     * </pre>
     * <li>{@code com.sun.mail.util.logging.CollectorFormatter.format={13} alert reports since
     * {10,date}.\n}
     * <p>
     ...
     */
    @Override public String getTail(final Handler h) {
    ...
    private String formatRecord(final Handler h, final boolean reset) {
        ...
        return mf.format(new Object[] {
                finish(head), finish(msg), finish(tail), c, (c - 1L), t, (c - t), msl, msh,
     ...
     * created.
     */
    @SuppressWarnings("unchecked") private Comparator<? super LogRecord> initComparator(
            final String p) {
