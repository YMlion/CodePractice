    ...
    private void select() {
        ...
        try {
            while (!die) {
                ...
                if (die || Thread.currentThread().isInterrupted()) break;
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                logger.log(Level.FINEST,
                        "IdleManager got exception for folder: " + folderName(folder), ex);
            }
        }
    ...
    private void unwatchAll() {
        ...
        for (SelectionKey sk : keys) {
            ...
            try {
                ...
                logger.log(Level.FINEST,
                        "IdleManager exception while aborting idle for folder: " + folderName(
                                folder), ex);
            }
        }
