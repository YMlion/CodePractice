...
public class IMAPNestedMessage extends IMAPMessage {
     ...
     */
    @Override protected IMAPProtocol getProtocol() throws ProtocolException, FolderClosedException {
     ...
     */
    @Override protected boolean isREV1() throws FolderClosedException {
        return msg.isREV1();
    }
     ...
     */
    @Override protected Object getMessageCacheLock() {
     ...
     */
    @Override protected int getSequenceNumber() {
     ...
     */
    @Override protected void checkExpunged() throws MessageRemovedException {
        msg.checkExpunged();
    }
     ...
     * Message.isExpunged().
     */
    @Override public boolean isExpunged() {
     ...
     */
    @Override protected int getFetchBlockSize() {
     ...
     */
    @Override protected boolean ignoreBodyStructureSize() {
