    ...
    public BODYSTRUCTURE(FetchResponse r) throws ParsingException {
		 ...
		 */
            ...
            if (b == '(') {
                ...
                if (parseDebug) System.out.println("DEBUG IMAP: disposition " + disposition);
            ...
            if (r.peekByte() == '(') { // a list follows
                ...
                if (parseDebug) System.out.println("DEBUG IMAP: language len " + language.length);
            } else {
            ...
            while (r.readByte() == ' ') parseBodyExtension(r);
	     ...
	     */
            ...
            if (encoding != null && encoding.equalsIgnoreCase("NIL")) encoding = null;
            ...
            if (type.equalsIgnoreCase("text")) {
                ...
                if (r.peekByte() == '(') {    // the envelope follows
                    ...
                    if (parseDebug) {
                        System.out.println(
                                "DEBUG IMAP: " + "missing envelope and body of nested message");
                    }
                }
            } else {
