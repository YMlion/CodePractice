...
public class DefaultFolder extends IMAPFolder {
    ...
    @Override public synchronized Folder[] list(final String pattern) throws MessagingException {
        ListInfo[] li = null;
    ...
    @Override public synchronized Folder[] listSubscribed(final String pattern)
